...
public class OUTERSTAIRS {
	...
	private static final OUTERSTAIRS instance = new OUTERSTAIRS(MAIN.name, MAIN.texture);

	protected String fileName;
	protected String path, texture;
	protected BufferedWriter writer;

	public OUTERSTAIRS(String f, String tex) {
		texture = tex;
		String s = MAIN.DEBUG ? "C:/Users/User/Desktop/test" : "C:/Users/User/Desktop/JSONS/eotg/models/block";
		String s1 = MAIN.DEBUG ? "/" + f + "OUTER BLOCK MODEL.json" : "/" + f + "Outer.json";
		this.fileName = s1;
		this.path = s;
		File file = null;
